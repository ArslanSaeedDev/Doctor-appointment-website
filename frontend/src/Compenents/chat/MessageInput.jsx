  ...
  return (
    <div className="flex items-center gap-2 p-3 border-t bg-white">
      ...
      <button
        onClick={handleSend}
        disabled={!text.trim()}
        className="bg-primary text-white px-5 py-2 rounded-full text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 transition-opacity"
      >
        Send
      </button>
    </div>
